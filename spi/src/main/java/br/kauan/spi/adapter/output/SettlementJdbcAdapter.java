...
public class SettlementJdbcAdapter implements SettlementRepository {
    ...
    public List<PaymentTransaction> settleAcceptedPayments(
        ...
        return jdbcTemplate.execute((ConnectionCallback<List<PaymentTransaction>>) connection -> {
            ...
            try (var statement = connection.prepareStatement(sql)) {
                ...
                try (ResultSet resultSet = statement.executeQuery()) {
                    List<PaymentTransaction> settledPayments = new ArrayList<>();
                    while (resultSet.next()) {
                        settledPayments.add(toPaymentTransaction(resultSet));
                    }
    ...
    private PaymentTransaction toPaymentTransaction(ResultSet resultSet) throws SQLException {
