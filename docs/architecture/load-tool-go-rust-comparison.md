...
The common profile and execution plan, the [Go report](../performance/evidence/2026-08-29/go-comparison-sla-report.json), the [Rust report](../performance/evidence/2026-08-29/rust-comparison-sla-report.json), and their checksums are versioned in the [evidence manifest](../performance/evidence/2026-08-29/manifest.md). These artifacts support only the controlled generator comparison. The final capacity claim is supported separately by the two consecutive qualification reports identified in that manifest.
